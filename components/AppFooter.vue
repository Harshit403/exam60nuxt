    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-links">
          <h4>Courses</h4>
          <ul>
            <li><NuxtLink to="/cseet-test-series">CSEET Test Series</NuxtLink></li>
            <li><NuxtLink to="/cs-executive-test-series">CS Executive Test Series</NuxtLink></li>
            <li><NuxtLink to="/cs-professional-test-series">CS Professional Test Series</NuxtLink></li>
          </ul>
        </div>
